...
- ***justify-content*** —— 决定 *flex item* 在主轴上的**对齐方式**
  ...
  ###### <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/422ef4d905ae4f6d8f7eff7448a61251~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp#?w=997&h=293&s=123579&e=png&b=fff2ec" alt="img"/>
...
- ***align-items*** —— 定义 *flex item* 在交叉轴上如何对齐
  ...
  ###### <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e5f4061c453a430b84b779bf870c5831~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp#?w=920&h=455&s=173668&e=png&b=fff1e3" alt="img" style="zoom:80%;" />
...
- ***align-content*** —— 定义多根轴线的对齐方式（当 *item* 的排列出现换行时就会出现多根轴线）
  ...
  - *gap、row-gap、colum-gap* —— 设置容器内项目之间的间距，只控制项目与项目的间距，对项目与容器的间距不生效。
    ...
    <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e55f017264c34dd39ff7ad42edc49235~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp#?w=757&h=342&s=71279&e=png&b=fff4f0" alt="img">
...
- ***flex*** —— *flex-grow*、*flex-shrink* 和 *flex-basis* 的简写
  ...
  <img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/336353ba9b374448b3cc8bee2c16f273~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp#?w=865&h=501&s=135610&e=png&b=fefefe">
